...
INSERT INTO "new_Settings" ("booking_url", "business_name", "contact_email", "display_name", "facebook_url", "first_name", "github_url", "gmail_app_password", "gmail_user", "id", "instagram_url", "last_name", "linkedin_url", "phone", "professional_title", "sender_name", "signature_enabled", "signature_html", "website_url", "whatsapp_url") SELECT "booking_url", "business_name", "contact_email", "display_name", "facebook_url", "first_name", "github_url", "gmail_app_password", "gmail_user", "id", "instagram_url", "last_name", "linkedin_url", "phone", "professional_title", "sender_name", "signature_enabled", "signature_html", "website_url", "whatsapp_url" FROM "Settings";
DROP TABLE "Settings";
